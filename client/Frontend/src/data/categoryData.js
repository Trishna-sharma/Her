...
export const categoryData = {
  ...
  Shoes: [
    ...
    { id: 6, name: 'Everyday Edit', img: 'new-arrival.png', price: '$59' },
    { id: 7, name: 'Festive Edit', img: 'new-arrival.png', price: '$85' },
    { id: 8, name: 'Premium Edit', img: 'new-arrival.png', price: '$110' },
  ],
  Bags: [
    ...
    { id: 6, name: 'Everyday Edit', img: 'new-arrival.png', price: '$65' },
    { id: 7, name: 'Festive Edit', img: 'new-arrival.png', price: '$90' },
    { id: 8, name: 'Premium Edit', img: 'new-arrival.png', price: '$120' },
  ],
};
